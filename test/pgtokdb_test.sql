...
\echo ** Test12: bigint[] (J) type support
create type test12_t as (jj bigint[]);
create function test12(varchar, integer) returns setof test12_t as 'pgtokdb', 'getset' language c;
select * from test12('test12', 3);

\echo ** Test13: integer[] (I) type support
create type test13_t as (ii integer[]);
create function test13(varchar, integer) returns setof test13_t as 'pgtokdb', 'getset' language c;
select * from test13('test13', 3);

\echo ** Test14: real[] (E) type support
create type test14_t as (ee real[]);
create function test14(varchar, integer) returns setof test14_t as 'pgtokdb', 'getset' language c;
select * from test14('test14', 3);

\echo ** Test15: double precision[] (F) type support
create type test15_t as (ff double precision[]);
create function test15(varchar, integer) returns setof test15_t as 'pgtokdb', 'getset' language c;
select * from test15('test15', 3);

\echo ** Test16: Casting up kdb+ type h (short) to Postgres integer, bigint, real, and double precision
create type test16_t as (i integer, j bigint, e real, f double precision);
create function test16(varchar, smallint) returns setof test16_t as 'pgtokdb', 'getset' language c;
select * from test16('test16', cast(32767 as smallint));

\echo ** Test17: Casting up kdb+ type i (int) to Postgres bigint, real, and double precision
create type test17_t as (j bigint, e real, f double precision);
create function test17(varchar, integer) returns setof test17_t as 'pgtokdb', 'getset' language c;
select * from test17('test17', 2147483646);

\echo ** Test18: Casting up kdb+ type j (long) to Postgres real and double precision
create type test18_t as (e real, f double precision);
create function test18(varchar, bigint) returns setof test18_t as 'pgtokdb', 'getset' language c;
select * from test18('test18', 9223372036854775806);

\echo ** Test19: Casting up kdb+ type e (real) to Postgres double precision
create type test19_t as (f double precision);
create function test19(varchar, real) returns setof test19_t as 'pgtokdb', 'getset' language c;
select * from test19('test19', 5.5);


\echo '************** Exception Path Testing **************'

\echo ** Test20: Error on kdb+ not returning unkeyed table
create type test20_t as (j bigint);
create function test20(varchar) returns setof test20_t as 'pgtokdb', 'getset' language c;
select * from test20('test20[]');

\echo ** Test21: Unsupported argument types
create type test21_t as (j bigint);
create function test21(varchar, money) returns setof test21_t as 'pgtokdb', 'getset' language c;
select * from test21('test21', cast(9.99 as money));

\echo ** Test22: Unsupported return types
create type test22_t as (m money);
create function test22(varchar) returns setof test22_t as 'pgtokdb', 'getset' language c;
select * from test22('test22[]');

\echo ** Test23: Missing (mismatched) column name
create type test23_t as (jcol bigint);
create function test23(varchar) returns setof test23_t as 'pgtokdb', 'getset' language c;
select * from test23('test23[]');

\echo ** Test24: No conversion to smallint
create type test24_t as (c smallint);
create function test24(varchar) returns setof test24_t as 'pgtokdb', 'getset' language c;
select * from test24('test24[]');

\echo ** Test25: No conversion to integer
create type test25_t as (c integer);
create function test25(varchar) returns setof test25_t as 'pgtokdb', 'getset' language c;
select * from test25('test25[]');

\echo ** Test26: No conversion to bigint
create type test26_t as (c bigint);
create function test26(varchar) returns setof test26_t as 'pgtokdb', 'getset' language c;
select * from test26('test26[]');

\echo ** Test27: No conversion to real
create type test27_t as (c real);
create function test27(varchar) returns setof test27_t as 'pgtokdb', 'getset' language c;
select * from test27('test27[]');

\echo ** Test28: No conversion to double precision
create type test28_t as (c double precision);
create function test28(varchar) returns setof test28_t as 'pgtokdb', 'getset' language c;
select * from test28('test28[]');

\echo ** Test29: No conversion to varchar
create type test29_t as (c varchar);
create function test29(varchar) returns setof test29_t as 'pgtokdb', 'getset' language c;
select * from test29('test29[]');

\echo ** Test30: No conversion to boolean
create type test30_t as (c boolean);
create function test30(varchar) returns setof test30_t as 'pgtokdb', 'getset' language c;
select * from test30('test30[]');

\echo ** Test31: No conversion to bytea
create type test31_t as (c bytea);
create function test31(varchar) returns setof test31_t as 'pgtokdb', 'getset' language c;
select * from test31('test31[]');

\echo ** Test32: No conversion to UUID
create type test32_t as (c UUID);
create function test32(varchar) returns setof test32_t as 'pgtokdb', 'getset' language c;
select * from test32('test32[]');

\echo ** Test33: No conversion to timestamp
create type test33_t as (c timestamp);
create function test33(varchar) returns setof test33_t as 'pgtokdb', 'getset' language c;
select * from test33('test33[]');

\echo ** Test34: No conversion to date
create type test34_t as (c date);
create function test34(varchar) returns setof test34_t as 'pgtokdb', 'getset' language c;
select * from test34('test34[]');

\echo ** Test35: No conversion to Postgres array[] from column of atoms
create type test35_t as (ii integer[]);
create function test35(varchar) returns setof test35_t as 'pgtokdb', 'getset' language c;
select * from test35('test35[]');

\echo ** Test36: Conversion type mismatch between array types 
...
\echo ** Test37: Unsupported kdb+ array type
...
\echo ** Test38: Kdb+ error
create type test38_t as (j bigint);
create function test38(varchar) returns setof test38_t as 'pgtokdb', 'getset' language c;
select * from test38('test38[]');

\echo ** Test39: Function has no arguments
create type test39_t as (j bigint);
create function test39() returns setof test39_t as 'pgtokdb', 'getset' language c;
select * from test39();

\echo ** Test40: First argument to function must be a varchar
create type test40_t as (j bigint);
create function test40(integer) returns setof test40_t as 'pgtokdb', 'getset' language c;
select * from test40(33);

\echo ** Test41: Exceeded maximum number of arguments
create type test41_t as (j bigint);
create function test41(
	varchar, integer, integer, integer,
	integer, integer, integer, integer,
	integer, integer) returns setof test41_t as 'pgtokdb', 'getset' language c;
select * from test41('test41[]', 1, 2, 3, 4, 5, 6, 7, 8, 9);

\echo '************** Performance Testing **************'

\echo ** Test42: Retrieving 100,000 wide (1000+256+16 bytes) row requiring additional pallocs
create type test42_t as (cc varchar, xx bytea, g UUID);
create function test42(varchar, integer) returns setof test42_t as 'pgtokdb', 'getset' language c;
\timing on
select count(*) from test42('test42', 100000);
\timing off

\echo ** Test43: Retrieving 10 million narrow rows (4 bytes)
create type test43_t as (i integer);
create function test43(varchar, integer) returns setof test43_t as 'pgtokdb', 'getset' language c;
\timing on
select count(*) from test43('test43', 1000000);
\timing off
